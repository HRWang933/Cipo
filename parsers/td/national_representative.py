...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:NationalRepresentative'
    ...
    sub_tags = ['.//com:CommentText',
                ...
                './/com:Contact/com:PostalAddressBag/com:PostalAddress/com:PostalStructuredAddress/com:AddressLineText[@com:sequenceNumber="4"]',
