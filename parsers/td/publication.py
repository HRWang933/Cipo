...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:PublicationBag/tmk:Publication'

    sub_tags = ['.//com:PublicationIdentifier',
                './/tmk:NationalPublication/tmk:PublicationStatusCategory',
                './/tmk:NationalPublication/tmk:PublicationActionDate' 
               ]
