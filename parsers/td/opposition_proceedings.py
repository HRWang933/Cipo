...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:LegalProceedingsBag/tmk:LegalProceedings/tmk:OppositionProceedingBag[@xsi:type="catmk:OppositionType"]'

    sub_tags = ['.//com:OppositionIdentifier',
                './/com:OppositionDate',
                ...
                './/tmk:PlaintiffBag/tmk:Plaintiff/tmk:Correspondent/com:CommentText',
                ...
                './/tmk:DefendantBag/tmk:Defendant/com:Contact/com:PostalAddressBag/com:PostalAddress/com:PostalStructuredAddress/com:GeographicRegionName',
