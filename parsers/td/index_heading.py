...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:NationalTrademarkInformation/catmk:IndexHeadingBag'

    sub_tags = ['.//catmk:IndexHeading[@com:sequenceNumber="1"]/catmk:IndexHeadingText',
                './/catmk:IndexHeading[@com:sequenceNumber="2"]/catmk:IndexHeadingText',
                './/catmk:IndexHeading[@com:sequenceNumber="3"]/catmk:IndexHeadingText'
               ]
