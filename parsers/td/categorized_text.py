...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:NationalTrademarkInformation/catmk:CategorizedTextBag'

    sub_tags = ['.//catmk:CategorizedText[@com:sequenceNumber="1"]',
                './/catmk:CategoryCode',
                './/cacom:CategoryDescription',
                './/cacom:ChangedDate',
                './/cacom:TextLineBag/cacom:TextLine' 
               ]
