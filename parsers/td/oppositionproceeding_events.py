...
def create_line(xml_part):
    ...
    repeat_tag_keylist = ['.//tmk:TrademarkBag/tmk:Trademark/tmk:LegalProceedingsBag/tmk:LegalProceedings/tmk:OppositionProceedingBag[@xsi:type="catmk:OppositionType"]',
                          './/catmk:ProceedingStageBag/catmk:ProceedingStage',
                          './/tmk:ProceedingEventBag/tmk:ProceedingEvent'
                         ]
    repeat_tag = {'.//tmk:TrademarkBag/tmk:Trademark/tmk:LegalProceedingsBag/tmk:LegalProceedings/tmk:OppositionProceedingBag[@xsi:type="catmk:OppositionType"]':['.//com:OppositionIdentifier'],
