...
def create_line(xml_part):
    ...
    parts_tag = './/tmk:TrademarkBag/tmk:Trademark/tmk:NationalTrademarkInformation/catmk:InterestedPartyBag/catmk:InterestedParty'

    sub_tags = ['.//catmk:InterestedPartyCategory',
