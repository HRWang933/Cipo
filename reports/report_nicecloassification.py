...
def send_search(reportType=None):
    ...
    query1 = """
             ...
             where markeventcode in (281,174,282,280)
    ...
    where markeventcode in (281,174,282,280) and markeventresponsedate<>'-' and markeventresponsedate<>' '
    ...
    df_final.to_excel('nice_classification_unrepresented.xlsx',index=None, engine='openpyxl')
    print(df_final.shape)
    #############################################################################
    ...
    def get_mail_params(rfile):
        ...
        var_params  = {
            'text'     : '',
            'subject'  : 'Nice Classification unrepresented searched: {} {}'.format(td.strftime("%B"), td.strftime("%Y")),
            'attach_file': rfile,
            }
        ...
        return mail_params
    send_mail(get_mail_params('nice_classification_unrepresented.xlsx'))
    print('email sent')
if __name__ == "__main__":
    try:
	print('='*30)
	print('Getting Nice Classification unrepresented searched')
	print('='*30)
        try:
